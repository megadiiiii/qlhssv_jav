...
INSERT INTO `class` VALUES ('HT21','74DCHT21','HT',74),('LG21','74DCLG21','LG',74),('RM1','Test 1','RM',1),('RM2','Test 2','RM',1),('RM3','Test 3','RM',1),('RM4','Test 4','RM',1);
...
INSERT INTO `cohort` VALUES (4,'K42',2000,2004);
...
INSERT INTO `faculties` VALUES ('36','Test'),('CKDL','Cơ khí động lực'),('CNTT','Công nghệ thông tin'),('CT','Công trình'),('KHUD','Khoa học ứng dụng'),('KTVT','Kinh tế vận tải'),('LCT','Luật - Chính trị'),('QT','Quản trị');
...
INSERT INTO `kyluat` VALUES (4,'453455','Khiển trách','1213','2025-12-09','2025-12-31','Test');
...
INSERT INTO `major` VALUES ('DT','Điện tử viễn thông','CNTT'),('EN','Ngôn ngữ Anh','KHUD'),('HT','Hệ thống thông tin','CNTT'),('LG','Logistics và quản lý chuỗi cung ứng','KTVT'),('QM','Quản trị Marketing','QT'),('RM','Test','36'),('Test','Test','36');
...
INSERT INTO `reward` VALUES (2,'74DCHT22041','2025-12-28','Test Edit','129'),(6,'74DCHT22041','2025-12-28','Đẹp trai','130'),(7,'121','2025-12-11','353','15353');
...
INSERT INTO `student` VALUES ('121','Nguyễn Minh','Anh','2025-10-21','Nữ','Hà Nam','134','314','314','LG21','Đang theo học'),('1211','12122','21212','2025-12-18','Nữ','12122','3123123','3123123','2231231223','HT21','Đang theo học'),('121111','1212211','2121211','2025-12-18','Nữ','12122','312312','312312','223123122','HT21','Đang theo học'),('12121','121212','1212','2025-12-11','Nam','212','12121','1212','1212','RM1','Bị đình chỉ'),('453455','453453','3453','2025-12-10','Nam','45345','34534','45345','534534','RM2','Buộc thôi học'),('74DCHT22041','Phạm Anh','Đức','2005-01-30','Nam','Thái Bình','0962819282','duc74dcht22041@st.utt.edu.vn','034205006846','HT21','Đang theo học'),('74DCLGMTRG','Tưởng Thị Ngọc','Ánh','2025-12-10','Nữ','Hà Nội','???','???','1224','RM1','Đang theo học');
...
-- Dump completed on 2026-01-01 13:16:34
